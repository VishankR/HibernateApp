...
/* customers */
INSERT INTO `customers` (`id`, `company`, `lastName`, `firstName`, `emailAddress`, `jobTitle`, `businessPhone`, `homePhone`, `mobilePhone`, `faxNumber`, `address`, `city`, `stateProvince`, `zipPostalCode`, `countryRegion`, `webPage`, `notes`, `attachments`) VALUES
...
/* 'employees' */
INSERT INTO `employees` (`id`, `company`, `lastName`, `firstName`, `emailAddress`, `jobTitle`, `businessPhone`, `homePhone`, `mobilePhone`, `faxNumber`, `address`, `city`, `stateProvince`, `zipPostalCode`, `countryRegion`, `webPage`, `notes`, `attachments`) VALUES 
...
/* products */
INSERT INTO `products` (`supplierIds`, `id`, `productCode`, `productName`, `description`, `standardCost`, `listPrice`, `reorderLevel`, `targetLevel`, `quantityPerUnit`, `discontinued`, `minimumReorderQuantity`, `category`, `attachments`) VALUES 
...
/* suppliers */
INSERT INTO `suppliers` (`id`, `company`, `lastName`, `firstName`, `emailAddress`, `jobTitle`, `businessPhone`, `homePhone`, `mobilePhone`, `faxNumber`, `address`, `city`, `stateProvince`, `zipPostalCode`, `countryRegion`, `webPage`, `notes`, `attachments`) VALUES 
...
/* shippers */
INSERT INTO `shippers` (`id`, `company`, `lastName`, `firstName`, `emailAddress`, `jobTitle`, `businessPhone`, `homePhone`, `mobilePhone`, `faxNumber`, `address`, `city`, `stateProvince`, `zipPostalCode`, `countryRegion`, `webPage`, `notes`, `attachments`) VALUES 
...
INSERT INTO `inventoryTransactionTypes` (`id`, `typeName`) VALUES 
    (1, 'Purchased'),
    (2, 'Sold'),
    (3, 'On Hold'),
    (4, 'Waste');
...
INSERT INTO `orderDetailsStatus` (`id`, `statusName`) VALUES 
     (0, 'None')
    ,(1, 'Allocated')
    ,(2, 'Invoiced')
    ,(3, 'Shipped')
...
INSERT INTO `ordersStatus` (`id`, `statusName`) VALUES 
     (0, 'New')
    ,(1, 'Invoiced')
    ,(2, 'Shipped')
    ,(3, 'Closed');
...
/* orders_tax_status */
INSERT INTO `ordersTaxStatus` (`id`, `taxStatusName`) VALUES 
     (0, 'Tax Exempt')
    ,(1, 'Taxable');
...
/* orders */
INSERT INTO `orders` (`id`, `employeeId`, `customerId`, `orderDate`, `shippedDate`, `shipperId`, `shipName`, `shipAddress`, `shipCity`, `shipStateProvince`, `shipZipPostalCode`, `shipCountryRegion`, `shippingFee`, `taxes`, `paymentType`, `paidDate`, `notes`, `taxRate`, `taxStatusId`, `statusId`) VALUES 
...
/* order_details */
INSERT INTO `orderDetails` (`id`, `orderId`, `productId`, `quantity`, `unitPrice`, `discount`, `statusId`, `dateAllocated`, `purchaseOrderId`, `inventoryId`) VALUES 
...
/*  purchase_orders */
INSERT INTO `purchaseOrders` (`id`, `supplierId`, `createdBy`, `submittedDate`, `creationDate`, `statusId`, `expectedDate`, `shippingFee`, `taxes`, `paymentDate`, `paymentAmount`, `paymentMethod`, `notes`, `approvedBy`, `approvedDate`, `submittedBy`) VALUES 
...
INSERT INTO `inventoryTransactions` (`id`, `transactionType`, `transactionCreatedDate`, `transactionModifiedDate`, `productId`, `quantity`, `purchaseOrderId`, `customerOrderId`, `comments`) VALUES 
...
INSERT INTO `purchaseOrderDetails` (`id`, `purchaseOrderId`, `productId`, `quantity`, `unitCost`, `dateReceived`, `postedToInventory`, `inventoryId`) VALUES 
...
/* invoices */
INSERT INTO `invoices` (`id`, `orderId`, `invoiceDate`, `dueDate`, `tax`, `shipping`, `amountDue`) VALUES 
...
/* strings */
INSERT INTO `strings` (`stringId`, `stringData`) VALUES 
     (2 , 'Northwind Traders')
